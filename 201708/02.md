...
Mac 版下载[地址](https://nssurge.com/)，下载完成后解压文件夹得到 Surge 程序，将其拖放到应用程序中打开
...
启用「系统偏好设置 — 网络 - Wi-Fi高级」 HTTP 和 HTTPS 代理： 127.0.0.1:6152 ，SOCKS 代理中设置为 127.0.0.1:6153
...
<img src="assets/02-5.png" width="681px" height="457px" />
